    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
                ...
                <span className='text-xs font-inter py-1.5 px-3 text-white bg-orange-500
                rounded-full' >20% OFF</span>
            </div>
            {/* {Room Raiting} */}
            ...
            justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0.15)] p-6 
            rounded-xl mx-auto mt-16 max-w-6xl '>
                ...
                gap-4 md:gap-10 text-gray-500'>
                    <div className='flex flex-col'>
                        ...
                        <input onChange={(e) => setCheckInDate(e.target.value)} min={new Date().toISOString().split('T')[0]}
                            type="date" placeholder='Check-In' id="checkInDate"
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input onChange={(e) => setCheckOutDate(e.target.value)} min={checkInDate} disabled={!checkInDate}
                            type="date" placeholder='Check-Out' id="checkOutDate"
                            className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 
                            outline-none' required />
                    </div>
                    {/* <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div> */}
                    <div className='flex flex-col'>
                        ...
                        <input onChange={(e) => setGuests(e.target.value)} value={guests}
                            type="number" placeholder='1' id="guests"
                ...
                max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>{isAvailable ? "Book Now" : "Check Availability"}</button>
            </form>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>Guests will be allocated on the ground floor according to availability.
                    ...
                    at the guest slot please mark the number of guests to get the exact price for groups. The Guests will be allocated ground floor according to availability.
            ...
            <div className='flex flex-col items-start gap-4'>
                <div className='flex gap-4'>
                    <img src={room.hotel.owner.image} alt="Host" className='h-14
                    w-14 md:h-18 md:w-18 rounded-full'/>
                    <div>
